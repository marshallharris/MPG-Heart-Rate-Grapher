...
bool AntChannelConfig(bool bMaster_)
{
  ...
  u8 au8ANTSetNetworkKey0[] =    {MESG_NETWORK_KEY_SIZE, MESG_NETWORK_KEY_ID, G_stAntSetupData.AntNetwork,0xB9 ,0xA5,0x21,0xFB,0xBD,0x72,0xC3,0x45, CS};
  u8 u8ErrorCount = 0;	
  ...
  /* Assign the network key */
  au8ANTSetNetworkKey0[11] = AntCalculateTxChecksum(au8ANTSetNetworkKey0);
  AntTxMessage(au8ANTSetNetworkKey0);
  u8ErrorCount += AntExpectResponse(MESG_NETWORK_KEY_ID, ANT_MSG_TIMEOUT_MS);
